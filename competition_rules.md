...
These competition rules are prepared for _28th RoboRacer Autonomous Racing Competition_. These are valid for this event only and extend the [General Rules]({% link rules.md %}).
...
<center>
<img src="images/competition_rules/Detroit_Mariott.jpg" alt="Ontario Exhibit Hall" style="height: 60vh; max-width: 100%; object-fit: cover" />
</center>
...
<center>
<img src="images/competition_rules/Ontario_Exhibit_Hall.jpg" alt="Ontario Exhibit Hall" style="width: 100%; height: 30vh; object-fit: cover" />
</center>
...
- The competitions-only registration rate is <span style="color: red"> TBA </span> per person. This fee is available only with a given "discount code", available to all teams during the Competition registration.
...
- Tueday, 16:30−18:00 (<span style="color: red"> Tentative </span>)
